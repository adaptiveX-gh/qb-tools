// Template panel — invoice template (client, rate, line item, HST)

function TemplatePanel({ tpl, setTpl, weekCount, setWeekCount, startDate, setStartDate }) {
    ...
    <div className="card">
      ...
      <div className="card__body">
        ...
        <div className="field" style={{marginTop:10}}>
          ...
          <div className="field__hint">Weeks run Sunday → Saturday.</div>
        </div>
        ...
        <div className="field">
          ...
          <div className="quickset">
            {[2, 4, 6, 8, 12].map(n => (
              <button key={n}
                className={'qpill ' + (weekCount === n ? 'active' : '')}
                onClick={() => setWeekCount(n)}>{n} weeks</button>
            ))}
